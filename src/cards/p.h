...
Card Plains = Card(std::set<CardSuperType>{BASIC}, std::set<CardType>{LAND}, std::set<CardSubType>{PLAINS}, 0, 0, 0,
					"Plains", 0, std::set<Color>{}, std::vector<std::shared_ptr<ActivatedAbility>>{
