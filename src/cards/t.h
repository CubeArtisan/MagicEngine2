...
Card TempestDjinn = newCard("Tempest Djinn", 3, {}, { CREATURE }, { DJINN }, 0, 4, 0, { BLUE }, Mana({ BLUE, BLUE, BLUE }), {},
	{}, {}, {}, { std::shared_ptr<StaticEffectHandler>(new PlusForEachHandler(BATTLEFIELD, LambdaProposition([](const std::shared_ptr<const Targetable>& target, const Environment& env, const xg::Guid& controller)
																							-> bool {
