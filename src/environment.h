...
struct Environment {
	...
	std::vector<AttackRestriction> getAttackRestrictions(xg::Guid attacker) const;
	std::vector<AttackRestriction> getAttackRestrictions(std::shared_ptr<const CardToken> attacker) const;
