...
void addObjectInternal(Zone<Args2...>& zone, const std::shared_ptr<const Targetable>& object, int index);
...
struct Environment {
	...
	int getLethalDamage(xg::Guid target, const std::shared_ptr<const CardToken>& blocker) const;
